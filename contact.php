        ...
        <div class="row py-2 px-lg-5">
            ...
            <div class="col-lg-6 text-center text-lg-right">
                <div class="d-inline-flex align-items-center">
                    <a class="text-white px-2" href="https://www.facebook.com/hend0505">
                    ...
                    <a class="text-white pl-2" href="https://www.facebook.com/hend0505">
            ...
            <div class="row align-items-center">
                    ...
                    <div class="bg-light d-flex flex-column justify-content-center px-5" style="height: 450px;">
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <div class="mt-n1">
                                ...
                                <p class="m-0">Pôle Technologique - El Ghazala. Zone industrielle Choutrana II.</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-5">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="mt-n1">
                                ...
                                <p class="m-0">ty-wink@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="section-title position-relative mb-4">
                        ...
                        <h1 class="display-4">Dîtes nous en plus</h1>
                    </div>
                    <div class="contact-form">
                        <form>
                            <div class="row">
                                ...
                                <div class="col-6 form-group">
                                    <input type="email" class="form-control border-top-0 border-right-0 border-left-0 p-0" placeholder="Votre mail" required="required">
                                </div>
                            </div>
                            ...
                            <div>
                                <button class="btn btn-outline-primary py-3 px-5" type="submit">Envoyer Message</button>
                            </div>
                        </form>
                    </div>
                </div>
