...
<html>
    ...
    if ($curPageName=="index.php") $type="active";  echo $type;?>"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    <a href="view/affichageclient.php" class="nav-item nav-link<?php $type="";
    if ($curPageName=="view/affichageclient.php") $type="active";  echo $type;?>"><i class="fa fa-users"></i>Client</a>
                    <a href="view/trajetadmin.php" class="nav-item nav-link <?php $type="";
    if ($curPageName=="view/trajetadmin.php") $type="active";  echo $type;?>"><i class="fa fa-road"></i>Trajet</a>
                    <a href="view/voitureadmin.php" class="nav-item nav-link <?php $type="";
    if ($curPageName=="view/voitureadmin.php") $type="active";  echo $type;?>"><i class="fa fa-car"></i>Voiture</a>
    ...
    if ($curPageName=="contactadmin.php") $type="active";  echo $type;?>"><i class="fa fa-phone"></i>Contact</a>
                    <a href="view/reservationadmin.php" class="nav-item nav-link <?php $type="";
    if ($curPageName=="view/reservationadmin.php") $type="active";  echo $type;?>"><i class="fa fa-business-time"></i>Reservation trajet</a>
    <a href="view/reservationconadmin.php" class="nav-item nav-link <?php $type="";
    if ($curPageName=="view/reservationconadmin.php") $type="active";  echo $type;?>"><i class="fa fa-business-time"></i>Reservation service</a>
