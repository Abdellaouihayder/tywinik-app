...
<head>
    ...
    <meta content="wcinh=device-wcinh, initial-scale=1.0" name="viewport">
    ...
    <!--Form trajet a remplir-->
        ...
        <h4>Choisissez le service:</h4>
            <select  class="form-control" name="servic" id="servicID">
                <option value="Déménagement">Déménagement/Emménagement</option>
        ...
        <br>
                ...
                <tr>
                    ...
                    <td><input type="number" name="distance" id="distance" maxlength="20"></td>
                </tr>
                <tr>
                    <td>
