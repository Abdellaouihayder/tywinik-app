...
?>
 <form action="modifiedrescon.php" method="POST">
            ...
            <tr>
                    ...
                    <td><input type="number" value="<?php echo $rescon['distance']; ?>" onchange="document.getElementById('test').innerText=this.value*<?php echo $_POST['tarif']; ?>" name="distance" id="distance" maxlength="20">
                    <p id='loj'> votre prix est :</p> 
                    <p id='test'></p>
                    <input type="hidden" value=<?PHP echo $rescon['idrescon']; ?> name="idrescon">
                    <input type="hidden" value=<?PHP echo $rescon['tarif']; ?> name="tarif">
                </td>
                </tr>
                <tr>
                    <td>
