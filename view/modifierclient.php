  ...
  <div class="container my-0 py-0 " >
    <div class="row " >
      <div class="container text-center my-0 py-0">
            <h2 class="text-white mt-4 mb-4"> Modifier Votre Compte <br><br></h2>
</div> 
    </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-8">
        <div class="card mb-4">
      <div class="card-body">
          <form  method="POST" action="updatedclient.php">
            <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-sm-9 text-center">
              <input type="text" name="phone" id="phone" value="<?= $user['phone']?>"required class="form-control  text-center">
              </div>
            </div>
            <hr>
            <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-sm-9 text-center">
              <input type="text" name="email" id="email" value="<?= $user['email']?>"required class="form-control text-center">
              </div>
            </div>
            <hr>
            <div class="row">
