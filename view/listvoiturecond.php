...
?>
<!-- DEBUT -->
<center><h1>Liste de mes voitures</h1></center><br>
		<table class="table table-striped">
			...
			<tr>
                ...
                <td><img length="70px" width="70px" src="upload/<?php echo $voiture['photo'];?>"></td>
				...
				<td>
					<td><a href="suppvoiture.php?matricule=<?php echo $voiture['matricule']?>"><input type="submit" value="supprimer"></a></td>
				</td>
			</tr>
			<?php
			}
        ...
        <center><a href="addvoiturecond.php"><input type="submit" class="btn btn-secondary px-3=4 px-lg-5" value="Ajouter une voiture"></a></center>
    <!-- FIN -->
