...
<div class="container-fluid p-0">
    ...
    if ($curPageName=="apropos.php") $type="active";  echo $type;?>">A propos</a>
                    <a href="view/addtrajetcond.php" class="nav-item nav-link <?php $type="";
    if ($curPageName=="view/addtrajetcond.php") $type="active";  echo $type;?>">Créer trajet</a>
    ...
    if ($curPageName=="avis.php") $type="active";  echo $type;?>">Avis</a>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle <?php $type="";
    if ($curPageName=="view/service.php")
     $type="active";  echo $type;?>" data-toggle="dropdown">Nos Services</a>
                        <div class="dropdown-menu m-0">
                            <a href="view/service.php?nb=1" class="dropdown-item <?php $type="";
    if ($curPageName=="view/service.php?nb=1") $type="active";  echo $type;?>">Déménagement/Emménagement</a>
                            <a href="view/service.php?nb=2" class="dropdown-item <?php $type="";
    if ($curPageName=="view/service.php?nb=2") $type="active";  echo $type;?>">Course Personnalisée</a>
                            <a href="view/service.php?nb=3" class="dropdown-item <?php $type="";
    if ($curPageName=="view/service.php?nb=3") $type="active";  echo $type;?>">Événementiel</a>
                        </div>
                    </div>
                    <!-- <a href="contact.php" class="nav-item nav-link <?php $type="";
    if ($curPageName=="contact.php") $type="active";  echo $type;?>">Contact</a> -->
    ...
    if ($curPageName=="reclamation.php") $type="active";  echo $type;?>">Reclamation</a>
                ...
                <a href="view/addclient.php" class="btn btn-outline-primary py-2 px-4 d-none d-lg-block mr-sm-1 <?php $type="";
    if ($curPageName=="view/addclient.php") $type="active";  echo $type;?>">S'inscrire</a>
                <a href="view/connecterclient.php" class="nav-item nav-link py-0 px-0 " ><button onclick="document.getElementById('id01').style.display='block'"  class="btn btn-outline-primary py-2 px-4 d-none d-lg-block mr-sm-0 <?php $type="";
    if ($curPageName=="view/connecterclient.php") $type="active";  echo $type;?>  rm">Se connecter</button></a>
            </div>
        </nav>
    </div>
...
<div class="container-fluid p-0">
    ...
    if ($curPageName=="admin/index.php") $type="active";  echo $type;?>"> Mode Admin</a>
                            <?php }?>
                        <a href="view/compteclient.php" class="dropdown-item <?php $type="";
    if ($curPageName=="view/compteclient.php") $type="active";  echo $type;?>">Compte</a>
                        <a href="view/deconnecterclient.php" class="dropdown-item<?php $type="";
    if ($curPageName=="view/deconnecterclient.php") $type="";  echo $type;?>">Déconnection</a>   
                        </div>
                    </div>
